...
People who are the most happy are “not strong democrats” and “not strong republicans”.
...
People who are clueless about their happiness are mostly independent party supporters.
...
ggplot(data = counts, aes(x = HappyIndex, y = counts, 
                          fill = Pol_Affl)) + 
  geom_bar(stat = "identity", position = position_dodge()) +
  ggtitle("Political Party by Happiness Level") + 
  xlab("Happiness Level") + 
  ylab("Count")

ggplot(data = GSS, aes(x = HappyIndex, fill = Pol_Affl)) +
  geom_bar(position = "fill") + 
  ggtitle("Political Party by Happiness Level") + 
  xlab("Happiness Level") + ylab("Proportion")
